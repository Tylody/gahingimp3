...
class GatewayDispatchHandler {
    ...
    [constants_1.GatewayDispatchEvents.MESSAGE_UPDATE](data) {
        ...
        const isListening = this.client.hasEventListener(constants_1.ClientEvents.MESSAGE_UPDATE);
        if (this.client.messages.has(messageId)) {
            message = this.client.messages.get(messageId);
            if (isListening) {
    ...
    [constants_1.GatewayDispatchEvents.RELATIONSHIP_ADD](data) {
        ...
        const payload = { differences, old, relationship, userId };
    ...
    [constants_1.GatewayDispatchEvents.STAGE_INSTANCE_CREATE](data) {
        const stageInstance = new structures_1.StageInstance(this.client, data);
        const payload = { stageInstance };
        this.client.emit(constants_1.ClientEvents.STAGE_INSTANCE_CREATE, payload);
    }
    [constants_1.GatewayDispatchEvents.STAGE_INSTANCE_DELETE](data) {
        let stageInstance;
        if (this.client.stageInstances.has(data['guild_id'], data['id'])) {
            ...
            stageInstance = new structures_1.StageInstance(this.client, data);
        }
        stageInstance.deleted = true;
        const payload = { stageInstance };
        this.client.emit(constants_1.ClientEvents.STAGE_INSTANCE_DELETE, payload);
    }
    [constants_1.GatewayDispatchEvents.STAGE_INSTANCE_UPDATE](data) {
        let differences = null;
        let old = null;
        let stageInstance;
        if (this.client.stageInstances.has(data['guild_id'], data['id'])) {
            stageInstance = this.client.stageInstances.get(data['guild_id'], data['id']);
            if (this.client.hasEventListener(constants_1.ClientEvents.STAGE_INSTANCE_UPDATE)) {
        ...
        const payload = { differences, old, stageInstance };
        this.client.emit(constants_1.ClientEvents.STAGE_INSTANCE_UPDATE, payload);
    }
    ...
    [constants_1.GatewayDispatchEvents.THREAD_CREATE](data) {
        let thread;
        if (this.client.channels.has(data['id'])) {
            ...
            thread = structures_1.createChannelFromData(this.client, data);
        ...
        this.client.emit(constants_1.ClientEvents.THREAD_CREATE, payload);
    }
    [constants_1.GatewayDispatchEvents.THREAD_DELETE](data) {
        let thread = null;
        if (this.client.channels.has(data['id'])) {
            thread = this.client.channels.get(data['id']);
            thread.deleted = true;
        ...
        this.client.emit(constants_1.ClientEvents.THREAD_DELETE, payload);
    }
    [constants_1.GatewayDispatchEvents.THREAD_LIST_SYNC](data) {
    }
    [constants_1.GatewayDispatchEvents.THREAD_MEMBER_UPDATE](data) {
        const isListening = this.client.hasEventListener(constants_1.ClientEvents.THREAD_MEMBER_UPDATE);
        let differences = null;
        let old = null;
        let threadMember;
        if (this.client.channels.has(data['id'])) {
            ...
            threadMember = new structures_1.ThreadMember(this.client, data);
        }
        const payload = { differences, old, threadMember };
        this.client.emit(constants_1.ClientEvents.THREAD_MEMBER_UPDATE, payload);
    }
    [constants_1.GatewayDispatchEvents.THREAD_MEMBERS_UPDATE](data) {
    }
    [constants_1.GatewayDispatchEvents.THREAD_UPDATE](data) {
        let thread;
        let differences = null;
        let old = null;
        const isListening = this.client.hasEventListener(constants_1.ClientEvents.THREAD_UPDATE);
        if (this.client.channels.has(data['id'])) {
            thread = this.client.channels.get(data['id']);
            if (isListening) {
        ...
        const payload = { differences, old, thread };
        this.client.emit(constants_1.ClientEvents.THREAD_UPDATE, payload);
    }
    ...
    [constants_1.GatewayDispatchEvents.USER_UPDATE](data) {
        ...
        const payload = { differences, old, user };
    ...
    [constants_1.GatewayDispatchEvents.VOICE_STATE_UPDATE](data) {
        ...
        const payload = { differences, joinedChannel, leftChannel, old, voiceState };
