...
class ComponentHandler {
    constructor() {
        this.listeners = new collections_1.BaseCollection();
    }
    delete(listenerId) {
    ...
    async execute(interaction) {
        ...
        if (listener) {
            const context = new utils_1.ComponentContext(interaction);
            try {
    ...
    insert(listener) {
        ...
        if (listenerId) {
            ...
            if (listener.timeout) {
                const timeout = listener._timeout = new detritus_utils_1.Timers.Timeout();
    ...
    replaceId(oldListenerId, newListenerId) {
